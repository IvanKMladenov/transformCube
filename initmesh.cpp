...
void InitMesh::add(const QVector3D &v, const QVector3D &n) {
...
void InitMesh::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4) {
...
void InitMesh::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2) {
